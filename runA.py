...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Taylor\\Downloads\\CSN Lab\\projects\\round_robin\\scripts\\scanner_portion\\psychopy_scripts\\runA\\runA.py',
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('runA.xlsx'),
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    trialComponents = [name, trait, fixation, trigger, response]
